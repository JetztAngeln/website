        ...
        const fetchWaterData = async () => {
            ...
            try {
                ...
                if (result.club_waters_by_pk) {
                    ...
                    setImageUrl(
                        result.club_waters_by_pk.image_id
                            ? `${nhost.storage.baseURL}/files/${result.club_waters_by_pk.image_id}`
                            : null,
                    );
                    setSelectedFishTypeIds(
                        result.club_waters_by_pk.fish_types || [],
                    );
                }
            } catch (err) {
        ...
        >
            ...
            <div className="space-y-4">
                ...
                <div className="flex items-center gap-2">
                    ...
                    />
                    <Label htmlFor="isDraft" className="h-3.5">
                        {t("isDraft")}
                    </Label>
                </div>
                ...
                <div className="flex items-center gap-2">
                    ...
                    />
                    <Label htmlFor="isMembersOnly" className="h-3.5">
                        {t("isMembersOnly")}
                    </Label>
                </div>
                ...
                <div>
                    ...
                    <div className="flex flex-wrap gap-2 mt-2">
                        {Object.values(FishType)
                            .map((e) => {
                                return { key: e, value: FishTypesT(e) };
                            })
                            .sort((a, b) =>
                                a.value.localeCompare(b.value, locale),
                            )
                            .map((fishType) => {
                                const isSelected = selectedFishTypeIds.includes(
                                    fishType.key,
                                );
                                return (
                                    <button
