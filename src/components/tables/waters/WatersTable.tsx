...
const WatersTable = () => {
    ...
    return (
        <div>
            <EditWaterModal isOpen={isOpen} closeModal={closeModal} waterId={selectedWaterId!} onSave={() => setSelectedWaterId(null)} />
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex gap-2">
                            ...
                            <button
                                ...
                                onClick={() =>
                                    setPage((old) =>
                                        data ? Math.min(old + 1, Math.ceil(data.length / pageSize) - 1) : old
                                    )
                                }
