...
const AppSidebar: React.FC = () => {
    ...
    const navItems: ReadonlyArray<NavItem> = [
        {
            ...
            name: "Dashboard",
            subItems: [{ name: t("overview"), path: "/dashboard" }],
        },
        {
            icon: <UsersIcon />,
            name: t("members"),
            subItems: [
                { name: t("membersOverview"), path: "/members" },
                { name: t("membersJoin"), path: "/members/join" },
            ],
        },
        {
            icon: <WavesIcon />,
    ...
    const othersItems: ReadonlyArray<NavItem> = [
        {
            icon: <FishIcon />,
            name: t("catches"),
            path: "/catches",
    ...
    // biome-ignore lint/correctness/useExhaustiveDependencies: we are not interested in title updates of navItems & otherItems here
    useEffect(() => {
    ...
    return (
        ...
        >
            <div
                className={`py-6 flex  ${!isExpanded && !isHovered
                        ? "lg:justify-center"
                        : "justify-start"
                    }`}
            >
